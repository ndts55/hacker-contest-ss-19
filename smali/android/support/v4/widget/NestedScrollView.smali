...
.field private final y:Landroid/support/v4/h/o;

.field private final z:Landroid/support/v4/h/l;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/h/o;

    new-instance p1, Landroid/support/v4/h/l;

    invoke-direct {p1, p0}, Landroid/support/v4/h/l;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->z:Landroid/support/v4/h/l;
    ...
    invoke-static {p0, p1}, Landroid/support/v4/h/r;->a(Landroid/view/View;Landroid/support/v4/h/b;)V
...
.method public a(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->z:Landroid/support/v4/h/l;

    invoke-virtual {v0, p1}, Landroid/support/v4/h/l;->c(I)V
...
.method public a(II)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/h/l;->a(II)Z
...
.method public b(Landroid/view/View;Landroid/view/View;II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/h/o;
...
.method public b(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/h/l;->a(I)Z
...
.method public computeScroll()V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/h/r;->d(Landroid/view/View;)V
...
.method public dispatchNestedFling(FFZ)Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/support/v4/h/l;->a(FFZ)Z
...
.method public dispatchNestedPreFling(FF)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/h/l;->a(FF)Z
...
.method public isNestedScrollingEnabled()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/h/l;->a()Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v4/widget/g;->a(Landroid/widget/EdgeEffect;FF)V
    ...
    invoke-static {v0, v1, v3}, Landroid/support/v4/widget/g;->a(Landroid/widget/EdgeEffect;FF)V
...
.method public setNestedScrollingEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/h/l;->a(Z)V
