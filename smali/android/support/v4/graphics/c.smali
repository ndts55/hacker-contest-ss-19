...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/graphics/c;->b:Landroid/support/v4/g/g;
...
.method public static a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    sget-object p2, Landroid/support/v4/graphics/c;->b:Landroid/support/v4/g/g;
...
.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/e/b$b;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v0, p0, p1, p2, p3}, Landroid/support/v4/graphics/h;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/e/b$b;I)Landroid/graphics/Typeface;
...
.method public static a(Landroid/content/Context;Landroid/support/v4/a/a/c$a;Landroid/content/res/Resources;IILandroid/support/v4/a/a/f$a;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    .locals 7

    instance-of v4, p1, Landroid/support/v4/a/a/c$d;

    if-eqz v4, :cond_3

    move-object v0, p1

    check-cast v0, Landroid/support/v4/a/a/c$d;
    ...
    invoke-virtual {v0}, Landroid/support/v4/a/a/c$d;->b()I
    ...
    invoke-virtual {v0}, Landroid/support/v4/a/a/c$d;->c()I
    ...
    :goto_2
    invoke-virtual {v0}, Landroid/support/v4/a/a/c$d;->a()Landroid/support/v4/e/a;
    ...
    invoke-static/range {v0 .. v6}, Landroid/support/v4/e/b;->a(Landroid/content/Context;Landroid/support/v4/e/a;Landroid/support/v4/a/a/f$a;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    ...
    check-cast v0, Landroid/support/v4/a/a/c$b;

    invoke-virtual {v1, p0, v0, p2, p4}, Landroid/support/v4/graphics/h;->a(Landroid/content/Context;Landroid/support/v4/a/a/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p5, v0, p6}, Landroid/support/v4/a/a/f$a;->a(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-virtual {p5, v1, p6}, Landroid/support/v4/a/a/f$a;->a(ILandroid/os/Handler;)V

    :cond_5
    :goto_3
    if-eqz v0, :cond_6

    sget-object v1, Landroid/support/v4/graphics/c;->b:Landroid/support/v4/g/g;
...
.method public static a(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    sget-object v0, Landroid/support/v4/graphics/c;->b:Landroid/support/v4/g/g;
