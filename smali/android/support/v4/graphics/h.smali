...
.method private a(Landroid/support/v4/a/a/c$b;I)Landroid/support/v4/a/a/c$c;
    .locals 1

    invoke-virtual {p1}, Landroid/support/v4/a/a/c$b;->a()[Landroid/support/v4/a/a/c$c;
...
.method public a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2, p3}, Landroid/support/v4/graphics/i;->a(Ljava/io/File;Landroid/content/res/Resources;I)Z
...
.method public a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/e/b$b;I)Landroid/graphics/Typeface;
    ...
    :cond_0
    invoke-virtual {p0, p3, p4}, Landroid/support/v4/graphics/h;->a([Landroid/support/v4/e/b$b;I)Landroid/support/v4/e/b$b;
    ...
    invoke-virtual {p2}, Landroid/support/v4/e/b$b;->a()Landroid/net/Uri;
...
.method public a(Landroid/content/Context;Landroid/support/v4/a/a/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    .locals 1

    invoke-direct {p0, p2, p4}, Landroid/support/v4/graphics/h;->a(Landroid/support/v4/a/a/c$b;I)Landroid/support/v4/a/a/c$c;
    ...
    :cond_0
    invoke-virtual {p2}, Landroid/support/v4/a/a/c$c;->f()I

    move-result v0

    invoke-virtual {p2}, Landroid/support/v4/a/a/c$c;->a()Ljava/lang/String;

    move-result-object p2

    invoke-static {p1, p3, v0, p2, p4}, Landroid/support/v4/graphics/c;->a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
...
.method protected a(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2}, Landroid/support/v4/graphics/i;->a(Ljava/io/File;Ljava/io/InputStream;)Z
