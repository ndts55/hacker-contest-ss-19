...
.method public N()V
    ...
    iput-boolean v4, v1, Landroid/support/constraint/a/a/g;->aD:Z

    iput-boolean v4, v1, Landroid/support/constraint/a/a/g;->aE:Z

    iget-object v0, v1, Landroid/support/constraint/a/a/g;->D:Landroid/support/constraint/a/a/f;

    if-eqz v0, :cond_1

    iget-object v0, v1, Landroid/support/constraint/a/a/g;->aB:Landroid/support/constraint/a/a/p;
    ...
    iput-object v0, v1, Landroid/support/constraint/a/a/g;->aB:Landroid/support/constraint/a/a/p;

    :cond_0
    iget-object v0, v1, Landroid/support/constraint/a/a/g;->aB:Landroid/support/constraint/a/a/p;

    invoke-virtual {v0, v1}, Landroid/support/constraint/a/a/p;->a(Landroid/support/constraint/a/a/f;)V

    iget v0, v1, Landroid/support/constraint/a/a/g;->aj:I

    invoke-virtual {v1, v0}, Landroid/support/constraint/a/a/g;->h(I)V

    iget v0, v1, Landroid/support/constraint/a/a/g;->ak:I
    ...
    iget-object v0, v1, Landroid/support/constraint/a/a/g;->ai:Landroid/support/constraint/a/e;
    ...
    :cond_1
    iput v4, v1, Landroid/support/constraint/a/a/g;->I:I

    iput v4, v1, Landroid/support/constraint/a/a/g;->J:I

    :goto_0
    iget v0, v1, Landroid/support/constraint/a/a/g;->aC:I
    ...
    :cond_2
    invoke-virtual {v1, v7}, Landroid/support/constraint/a/a/g;->u(I)Z
    ...
    iput-boolean v9, v0, Landroid/support/constraint/a/e;->c:Z
    ...
    :goto_1
    iget-object v0, v1, Landroid/support/constraint/a/a/g;->C:[Landroid/support/constraint/a/a/f$a;
    ...
    iget-object v0, v1, Landroid/support/constraint/a/a/g;->ar:Ljava/util/List;
    ...
    sget-object v14, Landroid/support/constraint/a/a/f$a;->b:Landroid/support/constraint/a/a/f$a;
    ...
    iget-boolean v8, v1, Landroid/support/constraint/a/a/g;->ax:Z
    ...
    iget-object v7, v1, Landroid/support/constraint/a/a/g;->ar:Ljava/util/List;
    ...
    invoke-virtual {v7}, Landroid/support/constraint/a/a/h;->a()Ljava/util/List;
    ...
    iget-object v7, v7, Landroid/support/constraint/a/a/h;->a:Ljava/util/List;

    :goto_5
    check-cast v7, Ljava/util/ArrayList;

    iput-object v7, v1, Landroid/support/constraint/a/a/g;->az:Ljava/util/ArrayList;

    :cond_a
    invoke-direct/range {p0 .. p0}, Landroid/support/constraint/a/a/g;->V()V

    iget-object v7, v1, Landroid/support/constraint/a/a/g;->az:Ljava/util/ArrayList;
    ...
    iget-object v4, v1, Landroid/support/constraint/a/a/g;->az:Ljava/util/ArrayList;
    ...
    invoke-virtual {v4}, Landroid/support/constraint/a/a/q;->N()V
    ...
    :try_start_1
    iget-object v9, v1, Landroid/support/constraint/a/a/g;->ai:Landroid/support/constraint/a/e;
    ...
    invoke-virtual {v1, v0}, Landroid/support/constraint/a/a/g;->d(Landroid/support/constraint/a/e;)Z
    ...
    iget-object v8, v1, Landroid/support/constraint/a/a/g;->ai:Landroid/support/constraint/a/e;

    sget-object v9, Landroid/support/constraint/a/a/k;->a:[Z

    invoke-virtual {v1, v8, v9}, Landroid/support/constraint/a/a/g;->a(Landroid/support/constraint/a/e;[Z)V
    ...
    invoke-virtual {v1, v8}, Landroid/support/constraint/a/a/g;->c(Landroid/support/constraint/a/e;)V
    ...
    iget-object v9, v1, Landroid/support/constraint/a/a/g;->az:Ljava/util/ArrayList;
    ...
    iget-object v12, v9, Landroid/support/constraint/a/a/f;->C:[Landroid/support/constraint/a/a/f$a;

    const/16 v17, 0x0

    aget-object v12, v12, v17

    sget-object v0, Landroid/support/constraint/a/a/f$a;->c:Landroid/support/constraint/a/a/f$a;

    if-ne v12, v0, :cond_11

    invoke-virtual {v9}, Landroid/support/constraint/a/a/f;->p()I

    move-result v0

    invoke-virtual {v9}, Landroid/support/constraint/a/a/f;->q()I

    move-result v12

    if-ge v0, v12, :cond_11

    sget-object v0, Landroid/support/constraint/a/a/k;->a:[Z
    ...
    iget-object v0, v9, Landroid/support/constraint/a/a/f;->C:[Landroid/support/constraint/a/a/f$a;
    ...
    invoke-virtual {v9}, Landroid/support/constraint/a/a/f;->r()I

    move-result v0

    invoke-virtual {v9}, Landroid/support/constraint/a/a/f;->s()I
    ...
    iget v4, v8, Landroid/support/constraint/a/a/f;->I:I

    invoke-virtual {v8}, Landroid/support/constraint/a/a/f;->p()I
    ...
    iget v4, v8, Landroid/support/constraint/a/a/f;->J:I

    invoke-virtual {v8}, Landroid/support/constraint/a/a/f;->r()I
    ...
    iget v4, v1, Landroid/support/constraint/a/a/g;->Q:I
    ...
    invoke-virtual {v1, v0}, Landroid/support/constraint/a/a/g;->j(I)V
    ...
    :goto_12
    iget v4, v1, Landroid/support/constraint/a/a/g;->P:I
    ...
    iget-object v4, v1, Landroid/support/constraint/a/a/g;->C:[Landroid/support/constraint/a/a/f$a;
    ...
    invoke-virtual {v0}, Landroid/support/constraint/a/a/h;->b()V
    ...
    iget-object v4, v1, Landroid/support/constraint/a/a/g;->D:Landroid/support/constraint/a/a/f;
    ...
    iput v3, v1, Landroid/support/constraint/a/a/g;->J:I
