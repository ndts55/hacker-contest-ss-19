.class Landroid/support/constraint/c$a;
...
.method private constructor <init>()V
    ...
    iput-boolean v0, p0, Landroid/support/constraint/c$a;->a:Z
    ...
    iput v3, p0, Landroid/support/constraint/c$a;->U:F
    ...
    iput v3, p0, Landroid/support/constraint/c$a;->ab:F

    const/high16 v4, 0x7fc00000    # Float.NaN

    iput v4, p0, Landroid/support/constraint/c$a;->ac:F

    iput v4, p0, Landroid/support/constraint/c$a;->ad:F
    ...
    iput-boolean v0, p0, Landroid/support/constraint/c$a;->ar:Z

    iput v1, p0, Landroid/support/constraint/c$a;->as:I

    iput v1, p0, Landroid/support/constraint/c$a;->at:I

    return-void
.end method

.method synthetic constructor <init>(Landroid/support/constraint/c$1;)V
    .locals 0
...
.method private a(ILandroid/support/constraint/ConstraintLayout$a;)V
    ...
    iput p1, p0, Landroid/support/constraint/c$a;->k:I
    ...
    iput p1, p0, Landroid/support/constraint/c$a;->m:I

    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->j:I

    iput p1, p0, Landroid/support/constraint/c$a;->n:I

    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->k:I
    ...
    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->p:I

    iput p1, p0, Landroid/support/constraint/c$a;->q:I

    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->q:I

    iput p1, p0, Landroid/support/constraint/c$a;->r:I

    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->r:I
    ...
    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->z:F

    iput p1, p0, Landroid/support/constraint/c$a;->u:F

    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->A:F

    iput p1, p0, Landroid/support/constraint/c$a;->v:F

    iget-object p1, p2, Landroid/support/constraint/ConstraintLayout$a;->B:Ljava/lang/String;

    iput-object p1, p0, Landroid/support/constraint/c$a;->w:Ljava/lang/String;
    ...
    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->o:F

    iput p1, p0, Landroid/support/constraint/c$a;->z:F
    ...
    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->c:F

    iput p1, p0, Landroid/support/constraint/c$a;->g:F
    ...
    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->F:F

    iput p1, p0, Landroid/support/constraint/c$a;->Q:F

    iget p1, p2, Landroid/support/constraint/ConstraintLayout$a;->E:F

    iput p1, p0, Landroid/support/constraint/c$a;->R:F
    ...
    iget-boolean p1, p2, Landroid/support/constraint/ConstraintLayout$a;->T:Z

    iput-boolean p1, p0, Landroid/support/constraint/c$a;->ah:Z

    iget-boolean p1, p2, Landroid/support/constraint/ConstraintLayout$a;->U:Z

    iput-boolean p1, p0, Landroid/support/constraint/c$a;->ai:Z
    ...
    iput p1, p0, Landroid/support/constraint/c$a;->ao:I
    ...
    iput p1, p0, Landroid/support/constraint/c$a;->aq:F
...
.method private a(ILandroid/support/constraint/d$a;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/support/constraint/c$a;->a(ILandroid/support/constraint/ConstraintLayout$a;)V

    iget p1, p2, Landroid/support/constraint/d$a;->an:F
    ...
    iget p1, p2, Landroid/support/constraint/d$a;->az:F

    iput p1, p0, Landroid/support/constraint/c$a;->ag:F

    iget p1, p2, Landroid/support/constraint/d$a;->ap:F

    iput p1, p0, Landroid/support/constraint/c$a;->W:F

    iget-boolean p1, p2, Landroid/support/constraint/d$a;->ao:Z

    iput-boolean p1, p0, Landroid/support/constraint/c$a;->V:Z

    return-void
.end method

.method private a(Landroid/support/constraint/b;ILandroid/support/constraint/d$a;)V
    .locals 0

    invoke-direct {p0, p2, p3}, Landroid/support/constraint/c$a;->a(ILandroid/support/constraint/d$a;)V
    ...
    iput p2, p0, Landroid/support/constraint/c$a;->at:I
    ...
    iput p2, p0, Landroid/support/constraint/c$a;->as:I

    invoke-virtual {p1}, Landroid/support/constraint/a;->getReferencedIds()[I

    move-result-object p1

    iput-object p1, p0, Landroid/support/constraint/c$a;->au:[I

    :cond_0
    return-void
.end method

.method static synthetic a(Landroid/support/constraint/c$a;ILandroid/support/constraint/d$a;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/support/constraint/c$a;->a(ILandroid/support/constraint/d$a;)V

    return-void
.end method

.method static synthetic a(Landroid/support/constraint/c$a;Landroid/support/constraint/b;ILandroid/support/constraint/d$a;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroid/support/constraint/c$a;->a(Landroid/support/constraint/b;ILandroid/support/constraint/d$a;)V
...
# virtual methods
.method public a()Landroid/support/constraint/c$a;
    .locals 3
    ...
    iget v1, p0, Landroid/support/constraint/c$a;->at:I

    iput v1, v0, Landroid/support/constraint/c$a;->at:I

    iget-object v1, p0, Landroid/support/constraint/c$a;->au:[I

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/constraint/c$a;->au:[I

    iget-object v2, p0, Landroid/support/constraint/c$a;->au:[I
    ...
    iput-object v1, v0, Landroid/support/constraint/c$a;->au:[I
    ...
    iget-boolean v1, p0, Landroid/support/constraint/c$a;->ar:Z

    iput-boolean v1, v0, Landroid/support/constraint/c$a;->ar:Z
...
.method public synthetic clone()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Landroid/support/constraint/c$a;->a()Landroid/support/constraint/c$a;
