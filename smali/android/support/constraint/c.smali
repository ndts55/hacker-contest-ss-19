...
.method static constructor <clinit>()V
    ...
    sget v1, Landroid/support/constraint/g$b;->ConstraintSet_layout_constraintWidth_percent:I
    ...
    sget v1, Landroid/support/constraint/g$b;->ConstraintSet_layout_constraintHeight_percent:I
    ...
    sget v1, Landroid/support/constraint/g$b;->ConstraintSet_chainUseRtl:I
    ...
    sget v1, Landroid/support/constraint/g$b;->ConstraintSet_barrierDirection:I
    ...
    sget v1, Landroid/support/constraint/g$b;->ConstraintSet_constraint_referenced_ids:I
    ...
    sget v1, Landroid/support/constraint/g$b;->ConstraintSet_barrierAllowsGoneWidgets:I
...
.method private a(Landroid/view/View;Ljava/lang/String;)[I
    ...
    :try_start_0
    const-class v6, Landroid/support/constraint/g$a;
...
.method a(Landroid/support/constraint/ConstraintLayout;)V
    ...
    instance-of v8, v5, Landroid/support/constraint/a;

    if-eqz v8, :cond_0

    iput v4, v7, Landroid/support/constraint/c$a;->at:I

    :cond_0
    iget v8, v7, Landroid/support/constraint/c$a;->at:I

    if-eq v8, v3, :cond_3

    iget v3, v7, Landroid/support/constraint/c$a;->at:I
    ...
    iget-boolean v4, v7, Landroid/support/constraint/c$a;->ar:Z

    invoke-virtual {v3, v4}, Landroid/support/constraint/a;->setAllowsGoneWidget(Z)V

    iget-object v4, v7, Landroid/support/constraint/c$a;->au:[I
    ...
    :cond_2
    iget-object v4, v7, Landroid/support/constraint/c$a;->av:Ljava/lang/String;
    ...
    iput-object v4, v7, Landroid/support/constraint/c$a;->au:[I
    ...
    iget v5, v2, Landroid/support/constraint/c$a;->at:I
    ...
    iget-object v6, v2, Landroid/support/constraint/c$a;->au:[I
    ...
    :cond_b
    iget-object v6, v2, Landroid/support/constraint/c$a;->av:Ljava/lang/String;

    if-eqz v6, :cond_c

    iget-object v6, v2, Landroid/support/constraint/c$a;->av:Ljava/lang/String;

    invoke-direct {p0, v5, v6}, Landroid/support/constraint/c;->a(Landroid/view/View;Ljava/lang/String;)[I

    move-result-object v6

    iput-object v6, v2, Landroid/support/constraint/c$a;->au:[I

    goto :goto_4

    :cond_c
    :goto_5
    iget v6, v2, Landroid/support/constraint/c$a;->as:I
    ...
    invoke-virtual {v5}, Landroid/support/constraint/a;->a()V
