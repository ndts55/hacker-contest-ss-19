...
.method public a(FLandroid/support/design/c/d$d;Landroid/support/design/c/d$d;)Landroid/support/design/c/d$d;
    ...
    invoke-static {v1, v2, p1}, Landroid/support/design/widget/g;->a(FFF)F
    ...
    invoke-static {v2, v3, p1}, Landroid/support/design/widget/g;->a(FFF)F

    move-result v2

    iget p2, p2, Landroid/support/design/c/d$d;->c:F

    iget p3, p3, Landroid/support/design/c/d$d;->c:F

    invoke-static {p2, p3, p1}, Landroid/support/design/widget/g;->a(FFF)F

    move-result p1

    invoke-virtual {v0, v1, v2, p1}, Landroid/support/design/c/d$d;->a(FFF)V

    iget-object p1, p0, Landroid/support/design/c/d$a;->b:Landroid/support/design/c/d$d;
