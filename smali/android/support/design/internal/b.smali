...
.method public static varargs a(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {p0, p1, p3, p4}, Landroid/support/design/internal/b;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    invoke-static/range {p0 .. p5}, Landroid/support/design/internal/b;->b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
...
.method private static a(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    sget-object v0, Landroid/support/design/a$i;->ThemeEnforcement:[I

    invoke-virtual {p0, p1, v0, p2, p3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Landroid/support/design/a$i;->ThemeEnforcement_enforceMaterialTheme:I
    ...
    invoke-static {p0}, Landroid/support/design/internal/b;->b(Landroid/content/Context;)V
...
.method private static a(Landroid/content/Context;[ILjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Landroid/support/design/internal/b;->a(Landroid/content/Context;[I)Z
...
.method public static b(Landroid/content/Context;)V
    ...
    sget-object v0, Landroid/support/design/internal/b;->b:[I
...
.method private static varargs b(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)V
    ...
    sget v1, Landroid/support/design/a$i;->ThemeEnforcement_enforceTextAppearance:I
    ...
    :cond_1
    invoke-static/range {p0 .. p5}, Landroid/support/design/internal/b;->c(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Z
    ...
    :cond_2
    :goto_0
    sget p0, Landroid/support/design/a$i;->ThemeEnforcement_android_textAppearance:I
