...
.method private a(Landroid/support/design/transformation/FabTransformationBehavior$a;Landroid/support/design/a/i;FF)F
    ...
    invoke-virtual {p1, v4}, Landroid/support/design/a/h;->b(Ljava/lang/String;)Landroid/support/design/a/i;
    ...
    invoke-static {p3, p4, p1}, Landroid/support/design/a/a;->a(FFF)F
...
.method private a(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    sget v0, Landroid/support/design/a$e;->mtrl_child_content_container:I
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;FFLjava/util/List;Ljava/util/List;)V
    ...
    instance-of v2, v8, Landroid/support/design/c/d;
    ...
    check-cast v13, Landroid/support/design/c/d;
    ...
    invoke-virtual {v0, v4}, Landroid/support/design/widget/FloatingActionButton;->a(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0, v4}, Landroid/support/design/a/h;->b(Ljava/lang/String;)Landroid/support/design/a/i;
    ...
    invoke-direct {v0, v2, v3, v10}, Landroid/support/design/c/d$d;-><init>(FFF)V

    invoke-interface {v13, v0}, Landroid/support/design/c/d;->setRevealInfo(Landroid/support/design/c/d$d;)V

    :cond_1
    if-eqz p4, :cond_2

    invoke-interface {v13}, Landroid/support/design/c/d;->getRevealInfo()Landroid/support/design/c/d$d;
    ...
    invoke-static/range {v14 .. v19}, Landroid/support/design/widget/g;->a(FFFFFF)F

    move-result v0

    invoke-static {v13, v2, v3, v0}, Landroid/support/design/c/a;->a(Landroid/support/design/c/d;FFF)Landroid/animation/Animator;

    move-result-object v9

    new-instance v0, Landroid/support/design/transformation/FabTransformationBehavior$4;

    invoke-direct {v0, v12, v13}, Landroid/support/design/transformation/FabTransformationBehavior$4;-><init>(Landroid/support/design/transformation/FabTransformationBehavior;Landroid/support/design/c/d;)V

    invoke-virtual {v9, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {v11}, Landroid/support/design/a/i;->a()J
    ...
    iget v6, v0, Landroid/support/design/c/d$d;->c:F

    invoke-static {v13, v2, v3, v10}, Landroid/support/design/c/a;->a(Landroid/support/design/c/d;FFF)Landroid/animation/Animator;
    ...
    invoke-virtual {v11}, Landroid/support/design/a/i;->b()J

    move-result-wide v4

    iget-object v0, v9, Landroid/support/design/transformation/FabTransformationBehavior$a;->a:Landroid/support/design/a/h;

    invoke-virtual {v0}, Landroid/support/design/a/h;->a()J
    ...
    :goto_1
    invoke-virtual {v15, v9}, Landroid/support/design/a/i;->a(Landroid/animation/Animator;)V

    move-object/from16 v0, p8

    invoke-interface {v0, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v13}, Landroid/support/design/c/a;->a(Landroid/support/design/c/d;)Landroid/animation/Animator$AnimatorListener;
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {p2}, Landroid/support/v4/h/r;->l(Landroid/view/View;)F

    move-result p7

    invoke-static {p1}, Landroid/support/v4/h/r;->l(Landroid/view/View;)F
    ...
    invoke-virtual {p2, p3}, Landroid/support/design/a/h;->b(Ljava/lang/String;)Landroid/support/design/a/i;

    move-result-object p2

    invoke-virtual {p2, p1}, Landroid/support/design/a/i;->a(Landroid/animation/Animator;)V
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    :goto_1
    invoke-virtual {v7, v8}, Landroid/support/design/a/h;->b(Ljava/lang/String;)Landroid/support/design/a/i;
    ...
    :goto_2
    invoke-virtual {v12, v14}, Landroid/support/design/a/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {v13, v15}, Landroid/support/design/a/i;->a(Landroid/animation/Animator;)V
...
.method private b(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {p2, p4}, Landroid/support/design/a/h;->b(Ljava/lang/String;)Landroid/support/design/a/i;

    move-result-object p2

    invoke-virtual {p2, p3}, Landroid/support/design/a/i;->a(Landroid/animation/Animator;)V

    invoke-interface {p6, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p2, Landroid/support/design/transformation/FabTransformationBehavior$3;

    invoke-direct {p2, p0, v0, p1}, Landroid/support/design/transformation/FabTransformationBehavior$3;-><init>(Landroid/support/design/transformation/FabTransformationBehavior;Landroid/support/design/c/d;Landroid/graphics/drawable/Drawable;)V
...
.method private c(Landroid/view/View;)I
    ...
    invoke-static {p1}, Landroid/support/v4/h/r;->s(Landroid/view/View;)Landroid/content/res/ColorStateList;
...
.method private c(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;Ljava/util/List;Ljava/util/List;)V
    ...
    instance-of p7, p2, Landroid/support/design/c/d;
    ...
    invoke-interface {p2, p1}, Landroid/support/design/c/d;->setCircularRevealScrimColor(I)V

    :cond_1
    sget-object p1, Landroid/support/design/c/d$c;->a:Landroid/util/Property;
    ...
    :cond_2
    sget-object p3, Landroid/support/design/c/d$c;->a:Landroid/util/Property;
...
.method private d(Landroid/view/View;Landroid/view/View;ZZLandroid/support/design/transformation/FabTransformationBehavior$a;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_0
    instance-of p1, p2, Landroid/support/design/c/d;

    if-eqz p1, :cond_1

    sget p1, Landroid/support/design/c/c;->a:I
    ...
    :cond_3
    sget-object p2, Landroid/support/design/a/d;->a:Landroid/util/Property;
...
.method protected b(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-static {v0, v13}, Landroid/support/design/a/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
