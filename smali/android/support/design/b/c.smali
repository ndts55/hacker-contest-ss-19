...
.method private i()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Landroid/support/design/b/c;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v3, p0, Landroid/support/design/b/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget v3, p0, Landroid/support/design/b/c;->g:I
...
.method private k()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, p0, Landroid/support/design/b/c;->k:Landroid/content/res/ColorStateList;
    ...
    iget-object v5, p0, Landroid/support/design/b/c;->t:Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v3, p0, Landroid/support/design/b/c;->v:Landroid/graphics/drawable/GradientDrawable;

    iget-object v3, p0, Landroid/support/design/b/c;->v:Landroid/graphics/drawable/GradientDrawable;

    iget v4, p0, Landroid/support/design/b/c;->g:I
    ...
    iget-object v2, p0, Landroid/support/design/b/c;->v:Landroid/graphics/drawable/GradientDrawable;
...
.method a(II)V
    ...
    iget v3, p0, Landroid/support/design/b/c;->f:I
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    sget-boolean p1, Landroid/support/design/b/c;->a:Z
    ...
    :cond_0
    iget-object p1, p0, Landroid/support/design/b/c;->q:Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/content/res/TypedArray;)V
    ...
    iput v0, p0, Landroid/support/design/b/c;->c:I
    ...
    iput v0, p0, Landroid/support/design/b/c;->d:I
    ...
    iput v0, p0, Landroid/support/design/b/c;->e:I
    ...
    iput v0, p0, Landroid/support/design/b/c;->f:I
    ...
    iput v0, p0, Landroid/support/design/b/c;->g:I
    ...
    iput v0, p0, Landroid/support/design/b/c;->h:I
    ...
    iput-object v0, p0, Landroid/support/design/b/c;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    sget v2, Landroid/support/design/a$i;->MaterialButton_backgroundTint:I
    ...
    iput-object v0, p0, Landroid/support/design/b/c;->j:Landroid/content/res/ColorStateList;
    ...
    sget v2, Landroid/support/design/a$i;->MaterialButton_strokeColor:I

    invoke-static {v0, p1, v2}, Landroid/support/design/e/a;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    iput-object v0, p0, Landroid/support/design/b/c;->k:Landroid/content/res/ColorStateList;
    ...
    sget v2, Landroid/support/design/a$i;->MaterialButton_rippleColor:I
    ...
    iget-object p1, p0, Landroid/support/design/b/c;->m:Landroid/graphics/Paint;
    ...
    iget-object p1, p0, Landroid/support/design/b/c;->b:Landroid/support/design/b/a;

    invoke-static {p1}, Landroid/support/v4/h/r;->g(Landroid/view/View;)I
    ...
    invoke-static {v1}, Landroid/support/v4/h/r;->h(Landroid/view/View;)I

    move-result v1

    iget-object v2, p0, Landroid/support/design/b/c;->b:Landroid/support/design/b/a;

    invoke-virtual {v2}, Landroid/support/design/b/a;->getPaddingBottom()I

    move-result v2

    iget-object v3, p0, Landroid/support/design/b/c;->b:Landroid/support/design/b/a;

    sget-boolean v4, Landroid/support/design/b/c;->a:Z
    ...
    :goto_0
    invoke-virtual {v3, v4}, Landroid/support/design/b/a;->setInternalBackground(Landroid/graphics/drawable/Drawable;)V

    iget-object v3, p0, Landroid/support/design/b/c;->b:Landroid/support/design/b/a;

    iget v4, p0, Landroid/support/design/b/c;->c:I

    add-int/2addr p1, v4

    iget v4, p0, Landroid/support/design/b/c;->e:I
    ...
    invoke-static {v3, p1, v0, v1, v2}, Landroid/support/v4/h/r;->a(Landroid/view/View;IIII)V
...
.method a(Landroid/graphics/Canvas;)V
    ...
    iget-object v5, p0, Landroid/support/design/b/c;->n:Landroid/graphics/Rect;

    iget v5, v5, Landroid/graphics/Rect;->bottom:I

    int-to-float v5, v5

    iget v6, p0, Landroid/support/design/b/c;->h:I
    ...
    iget v6, p0, Landroid/support/design/b/c;->f:I
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object p1, p0, Landroid/support/design/b/c;->i:Landroid/graphics/PorterDuff$Mode;
...
.method c(I)V
    ...
    invoke-virtual {p1}, Landroid/support/design/b/a;->invalidate()V
