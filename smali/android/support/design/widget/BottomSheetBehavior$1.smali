...
.method public a(Landroid/view/View;)I
    ...
    iget-boolean p1, p1, Landroid/support/design/widget/BottomSheetBehavior;->d:Z

    if-eqz p1, :cond_0

    iget-object p1, p0, Landroid/support/design/widget/BottomSheetBehavior$1;->a:Landroid/support/design/widget/BottomSheetBehavior;

    iget p1, p1, Landroid/support/design/widget/BottomSheetBehavior;->g:I
    ...
    iget p1, p1, Landroid/support/design/widget/BottomSheetBehavior;->c:I
...
.method public a(Landroid/view/View;II)I
    ...
    iget-boolean p3, p3, Landroid/support/design/widget/BottomSheetBehavior;->d:Z
    ...
    iget p3, p3, Landroid/support/design/widget/BottomSheetBehavior;->c:I

    :goto_0
    invoke-static {p2, p1, p3}, Landroid/support/v4/c/a;->a(III)I
...
.method public a(Landroid/view/View;FF)V
    ...
    iget v0, p2, Landroid/support/design/widget/BottomSheetBehavior;->b:I
    ...
    iget-boolean v5, v5, Landroid/support/design/widget/BottomSheetBehavior;->d:Z
    ...
    iget-object v6, p0, Landroid/support/design/widget/BottomSheetBehavior$1;->a:Landroid/support/design/widget/BottomSheetBehavior;

    iget v6, v6, Landroid/support/design/widget/BottomSheetBehavior;->c:I
    ...
    iget p2, p2, Landroid/support/design/widget/BottomSheetBehavior;->c:I
    ...
    iget v0, p2, Landroid/support/design/widget/BottomSheetBehavior;->a:I
    ...
    iget v0, p2, Landroid/support/design/widget/BottomSheetBehavior;->c:I
    ...
    iget-object p3, p3, Landroid/support/design/widget/BottomSheetBehavior;->f:Landroid/support/v4/widget/q;

    invoke-virtual {p1}, Landroid/view/View;->getLeft()I

    move-result v0

    invoke-virtual {p3, v0, p2}, Landroid/support/v4/widget/q;->a(II)Z
    ...
    invoke-direct {p2, p3, p1, v2}, Landroid/support/design/widget/BottomSheetBehavior$c;-><init>(Landroid/support/design/widget/BottomSheetBehavior;Landroid/view/View;I)V

    invoke-static {p1, p2}, Landroid/support/v4/h/r;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public a(Landroid/view/View;I)Z
    ...
    iget-object p2, p2, Landroid/support/design/widget/BottomSheetBehavior;->i:Ljava/lang/ref/WeakReference;
