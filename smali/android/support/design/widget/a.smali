...
.method private a()Landroid/graphics/Shader;
    ...
    iget-object v0, p0, Landroid/support/design/widget/a;->b:Landroid/graphics/Rect;

    invoke-virtual {p0, v0}, Landroid/support/design/widget/a;->copyBounds(Landroid/graphics/Rect;)V

    iget v1, p0, Landroid/support/design/widget/a;->e:F
    ...
    iget v3, p0, Landroid/support/design/widget/a;->f:I

    iget v4, p0, Landroid/support/design/widget/a;->k:I

    invoke-static {v3, v4}, Landroid/support/v4/graphics/a;->a(II)I
    ...
    iget v3, p0, Landroid/support/design/widget/a;->g:I

    iget v5, p0, Landroid/support/design/widget/a;->k:I

    invoke-static {v3, v5}, Landroid/support/v4/graphics/a;->a(II)I
    ...
    invoke-static {v3, v4}, Landroid/support/v4/graphics/a;->b(II)I

    move-result v3

    iget v6, p0, Landroid/support/design/widget/a;->k:I

    invoke-static {v3, v6}, Landroid/support/v4/graphics/a;->a(II)I
    ...
    iget v3, p0, Landroid/support/design/widget/a;->i:I

    invoke-static {v3, v4}, Landroid/support/v4/graphics/a;->b(II)I

    move-result v3

    iget v7, p0, Landroid/support/design/widget/a;->k:I

    invoke-static {v3, v7}, Landroid/support/v4/graphics/a;->a(II)I
    ...
    iget v9, p0, Landroid/support/design/widget/a;->k:I

    invoke-static {v3, v9}, Landroid/support/v4/graphics/a;->a(II)I
    ...
    iget v3, p0, Landroid/support/design/widget/a;->h:I

    iget v10, p0, Landroid/support/design/widget/a;->k:I

    invoke-static {v3, v10}, Landroid/support/v4/graphics/a;->a(II)I
...
.method public a(Landroid/content/res/ColorStateList;)V
    ...
    iput-boolean p1, p0, Landroid/support/design/widget/a;->l:Z
...
.method protected onStateChange([I)Z
    ...
    iget v0, p0, Landroid/support/design/widget/a;->k:I
    ...
    iput p1, p0, Landroid/support/design/widget/a;->k:I

    :cond_0
    iget-boolean p1, p0, Landroid/support/design/widget/a;->l:Z
