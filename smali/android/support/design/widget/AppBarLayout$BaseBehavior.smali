...
.method private a(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    iget v5, v2, Landroid/support/design/widget/AppBarLayout$b;->topMargin:I

    sub-int/2addr v3, v5

    iget v2, v2, Landroid/support/design/widget/AppBarLayout$b;->bottomMargin:I
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;)Landroid/view/View;
    ...
    instance-of v3, v2, Landroid/support/v4/h/j;
...
.method private a(ILandroid/support/design/widget/AppBarLayout;Landroid/view/View;I)V
    ...
    :cond_1
    invoke-static {p3, v0}, Landroid/support/v4/h/r;->c(Landroid/view/View;I)V
...
.method private b(Landroid/support/design/widget/AppBarLayout;I)I
    ...
    invoke-static {v4}, Landroid/support/v4/h/r;->j(Landroid/view/View;)I
    ...
    :cond_0
    invoke-static {v4}, Landroid/support/v4/h/r;->p(Landroid/view/View;)Z
...
.method private c(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    invoke-static {v2}, Landroid/support/v4/h/r;->j(Landroid/view/View;)I
    ...
    iget v2, v3, Landroid/support/design/widget/AppBarLayout$b;->topMargin:I

    add-int/2addr v5, v2

    iget v2, v3, Landroid/support/design/widget/AppBarLayout$b;->bottomMargin:I
    ...
    invoke-static {v5, v0, v1}, Landroid/support/v4/c/a;->a(III)I
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p3}, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->a()Landroid/os/Parcelable;
    ...
    iget p1, p3, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->a:I

    iput p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->e:I

    iget p1, p3, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->b:F

    iput p1, p0, Landroid/support/design/widget/AppBarLayout$BaseBehavior;->g:F

    iget-boolean p1, p3, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->c:Z
...
.method public b(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Landroid/os/Parcelable;
    ...
    invoke-direct {v0, p1}, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;-><init>(Landroid/os/Parcelable;)V

    iput v3, v0, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->a:I
    ...
    :cond_0
    iput-boolean v2, v0, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->c:Z
    ...
    iput p1, v0, Landroid/support/design/widget/AppBarLayout$BaseBehavior$b;->b:F
