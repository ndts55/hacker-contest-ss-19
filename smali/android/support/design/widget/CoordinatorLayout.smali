...
.field private static final f:Landroid/support/v4/g/j$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final h:Landroid/support/v4/widget/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private t:Landroid/support/v4/h/z;

.field private u:Z

.field private v:Landroid/graphics/drawable/Drawable;

.field private w:Landroid/support/v4/h/p;

.field private final x:Landroid/support/v4/h/o;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/CoordinatorLayout;->f:Landroid/support/v4/g/j$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->h:Landroid/support/v4/widget/f;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/h/o;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/h/o;
...
.method private static a(Landroid/graphics/Rect;)V
    ...
    sget-object v0, Landroid/support/design/widget/CoordinatorLayout;->f:Landroid/support/v4/g/j$a;
...
.method private a(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/support/design/widget/CoordinatorLayout$e;II)V
    ...
    invoke-static {p1, p2}, Landroid/support/v4/h/d;->a(II)I
    ...
    invoke-static {p5, p2}, Landroid/support/v4/h/d;->a(II)I
...
.method private a(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    invoke-static {p1}, Landroid/support/v4/h/r;->w(Landroid/view/View;)Z
    ...
    invoke-static {v1, p3}, Landroid/support/v4/h/d;->a(II)I
...
.method private b(Landroid/support/v4/h/z;)Landroid/support/v4/h/z;
    .locals 4

    invoke-virtual {p1}, Landroid/support/v4/h/z;->e()Z
    ...
    invoke-static {v2}, Landroid/support/v4/h/r;->p(Landroid/view/View;)Z
    ...
    invoke-virtual {v3, p0, v2, p1}, Landroid/support/design/widget/CoordinatorLayout$b;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/support/v4/h/z;)Landroid/support/v4/h/z;
...
.method private d(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/z;

    if-eqz v1, :cond_0

    invoke-static {p0}, Landroid/support/v4/h/r;->p(Landroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p1}, Landroid/support/v4/h/r;->p(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/z;

    invoke-virtual {v2}, Landroid/support/v4/h/z;->a()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/z;->b()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/z;->c()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/z;->d()I
    ...
    invoke-static/range {v1 .. v6}, Landroid/support/v4/h/d;->a(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V
...
.method private e(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/r;->e(Landroid/view/View;I)V
...
.method private e(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->h:Landroid/support/v4/widget/f;

    invoke-virtual {v0, p1}, Landroid/support/v4/widget/f;->e(Ljava/lang/Object;)Z
...
.method private f()V
    ...
    iget-object v5, p0, Landroid/support/design/widget/CoordinatorLayout;->h:Landroid/support/v4/widget/f;
    ...
    iget-object v7, p0, Landroid/support/design/widget/CoordinatorLayout;->h:Landroid/support/v4/widget/f;

    invoke-virtual {v7, v6}, Landroid/support/v4/widget/f;->b(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v7, v6, v3}, Landroid/support/v4/widget/f;->a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->h:Landroid/support/v4/widget/f;

    invoke-virtual {v1}, Landroid/support/v4/widget/f;->b()Ljava/util/ArrayList;
...
.method private f(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/r;->d(Landroid/view/View;I)V
...
.method private g()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/h/p;
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->w:Landroid/support/v4/h/p;
...
.method a(Landroid/view/View;)Landroid/support/design/widget/CoordinatorLayout$e;
    ...
    invoke-interface {p1}, Landroid/support/design/widget/CoordinatorLayout$a;->getBehavior()Landroid/support/design/widget/CoordinatorLayout$b;
...
.method final a(Landroid/support/v4/h/z;)Landroid/support/v4/h/z;
    .locals 3

    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/z;
    ...
    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/z;
    ...
    invoke-virtual {p1}, Landroid/support/v4/h/z;->b()I
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->b(Landroid/support/v4/h/z;)Landroid/support/v4/h/z;
...
.method final a(I)V
    ...
    invoke-static {v12, v2}, Landroid/support/v4/h/d;->a(II)I
    ...
    :cond_c
    invoke-virtual {v15, v0, v13, v9}, Landroid/support/design/widget/CoordinatorLayout$b;->c(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)V
...
.method public a(Landroid/view/View;II[II)V
    ...
    invoke-virtual {p0, v14}, Landroid/support/design/widget/CoordinatorLayout;->a(I)V
...
.method a(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1, p2}, Landroid/support/v4/widget/r;->b(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/f;->c(Ljava/lang/Object;)Ljava/util/List;
...
.method b(Landroid/view/View;I)V
    ...
    invoke-static {v9, v0}, Landroid/support/v4/h/r;->e(Landroid/view/View;I)V

    :cond_2
    if-eqz v1, :cond_3

    invoke-static {v9, v1}, Landroid/support/v4/h/r;->d(Landroid/view/View;I)V
...
.method public b(Landroid/view/View;Landroid/view/View;II)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->x:Landroid/support/v4/h/o;

    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/support/v4/h/o;->a(Landroid/view/View;Landroid/view/View;II)V
...
.method public c(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/f;->d(Ljava/lang/Object;)Ljava/util/List;
...
.method public c(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/h/o;->a(Landroid/view/View;I)V
...
.method public final getLastWindowInsets()Landroid/support/v4/h/z;
    .locals 1
...
.method public onAttachedToWindow()V
    ...
    invoke-static {p0}, Landroid/support/v4/h/r;->o(Landroid/view/View;)V
...
.method protected onMeasure(II)V
    ...
    iget-object v3, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/z;

    if-eqz v3, :cond_1

    invoke-static/range {p0 .. p0}, Landroid/support/v4/h/r;->p(Landroid/view/View;)Z
    ...
    iget v0, v1, Landroid/support/design/widget/CoordinatorLayout$e;->e:I
    ...
    iget v11, v1, Landroid/support/design/widget/CoordinatorLayout$e;->c:I

    invoke-static {v11}, Landroid/support/design/widget/CoordinatorLayout;->d(I)I

    move-result v11

    invoke-static {v11, v10}, Landroid/support/v4/h/d;->a(II)I
    ...
    invoke-static/range {v20 .. v20}, Landroid/support/v4/h/r;->p(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/z;

    invoke-virtual {v0}, Landroid/support/v4/h/z;->a()I

    move-result v0

    iget-object v2, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/z;
    ...
    iget-object v11, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/z;

    invoke-virtual {v11}, Landroid/support/v4/h/z;->d()I
    ...
    iget v3, v1, Landroid/support/design/widget/CoordinatorLayout$e;->topMargin:I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/CoordinatorLayout$g;->a()Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v6, v0, v7, v1}, Landroid/support/design/widget/CoordinatorLayout$b;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setStatusBarBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_4
    invoke-static {p0}, Landroid/support/v4/h/r;->d(Landroid/view/View;)V
