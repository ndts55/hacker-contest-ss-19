...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/design/widget/f;->a:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroid/support/design/widget/f;->b:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/f;->a:Landroid/graphics/Rect;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Landroid/support/design/widget/f;->b:Landroid/graphics/Rect;
...
.method public a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;IIII)Z
    ...
    invoke-virtual {p0, v3}, Landroid/support/design/widget/f;->b(Ljava/util/List;)Landroid/view/View;

    move-result-object v3

    if-eqz v3, :cond_5

    invoke-static {v3}, Landroid/support/v4/h/r;->p(Landroid/view/View;)Z
    ...
    invoke-static {p2, v5}, Landroid/support/v4/h/r;->b(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, v3}, Landroid/support/design/widget/f;->b(Landroid/view/View;)I
...
.method protected b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/widget/f;->b(Ljava/util/List;)Landroid/view/View;
    ...
    iget-object v5, p0, Landroid/support/design/widget/f;->a:Landroid/graphics/Rect;
    ...
    invoke-virtual {p1}, Landroid/support/design/widget/CoordinatorLayout;->getLastWindowInsets()Landroid/support/v4/h/z;
    ...
    :cond_0
    iget-object p1, p0, Landroid/support/design/widget/f;->b:Landroid/graphics/Rect;

    iget v1, v1, Landroid/support/design/widget/CoordinatorLayout$e;->c:I

    invoke-static {v1}, Landroid/support/design/widget/f;->c(I)I
    ...
    invoke-virtual {p0, v0}, Landroid/support/design/widget/f;->c(Landroid/view/View;)I
    ...
    :cond_1
    invoke-super {p0, p1, p2, p3}, Landroid/support/design/widget/l;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
...
.method final c(Landroid/view/View;)I
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/design/widget/f;->a(Landroid/view/View;)F
    ...
    invoke-static {p1, v1, v0}, Landroid/support/v4/c/a;->a(III)I
