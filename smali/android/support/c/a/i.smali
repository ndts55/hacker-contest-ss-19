...
# instance fields
.field private b:Landroid/support/c/a/i$g;
...
.method constructor <init>(Landroid/support/c/a/i$g;)V
    ...
    iget-object v1, p1, Landroid/support/c/a/i$g;->c:Landroid/content/res/ColorStateList;

    iget-object p1, p1, Landroid/support/c/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v0, v1, p1}, Landroid/support/c/a/i;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

    move-result-object p1

    iput-object p1, p0, Landroid/support/c/a/i;->d:Landroid/graphics/PorterDuffColorFilter;
...
.method public static a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/support/c/a/i;
    ...
    iput-object p0, v0, Landroid/support/c/a/i;->c:Landroid/graphics/drawable/Drawable;

    new-instance p0, Landroid/support/c/a/i$h;

    iget-object p1, v0, Landroid/support/c/a/i;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p1}, Landroid/graphics/drawable/Drawable;->getConstantState()Landroid/graphics/drawable/Drawable$ConstantState;

    move-result-object p1

    invoke-direct {p0, p1}, Landroid/support/c/a/i$h;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V

    iput-object p0, v0, Landroid/support/c/a/i;->h:Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    invoke-static {p0, p1, v0, p2}, Landroid/support/c/a/i;->a(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/c/a/i;
...
.method private a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v1, v0, Landroid/support/c/a/i$g;->b:Landroid/support/c/a/i$f;
    ...
    invoke-static {p1, p2, v2, v3, v4}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    iput-object v2, v0, Landroid/support/c/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v2, v0, Landroid/support/c/a/i$g;->c:Landroid/content/res/ColorStateList;
    ...
    iget-boolean v4, v0, Landroid/support/c/a/i$g;->e:Z

    invoke-static {p1, p2, v2, v3, v4}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z

    move-result v2

    iput-boolean v2, v0, Landroid/support/c/a/i$g;->e:Z

    const-string v0, "viewportWidth"

    const/4 v2, 0x7

    iget v3, v1, Landroid/support/c/a/i$f;->f:F

    invoke-static {p1, p2, v0, v2, v3}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v0

    iput v0, v1, Landroid/support/c/a/i$f;->f:F

    const-string v0, "viewportHeight"

    const/16 v2, 0x8

    iget v3, v1, Landroid/support/c/a/i$f;->g:F

    invoke-static {p1, p2, v0, v2, v3}, Landroid/support/v4/a/a/g;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v0

    iput v0, v1, Landroid/support/c/a/i$f;->g:F

    iget v0, v1, Landroid/support/c/a/i$f;->f:F
    ...
    iget v0, v1, Landroid/support/c/a/i$f;->g:F
    ...
    iget v3, v1, Landroid/support/c/a/i$f;->d:F

    invoke-virtual {p1, v0, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v1, Landroid/support/c/a/i$f;->d:F

    const/4 v0, 0x2

    iget v3, v1, Landroid/support/c/a/i$f;->e:F

    invoke-virtual {p1, v0, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, v1, Landroid/support/c/a/i$f;->e:F

    iget v0, v1, Landroid/support/c/a/i$f;->d:F

    cmpg-float v0, v0, v2

    if-lez v0, :cond_3

    iget v0, v1, Landroid/support/c/a/i$f;->e:F
    ...
    invoke-virtual {v1}, Landroid/support/c/a/i$f;->getAlpha()F
    ...
    invoke-virtual {v1, p2}, Landroid/support/c/a/i$f;->setAlpha(F)V
    ...
    iput-object p1, v1, Landroid/support/c/a/i$f;->i:Ljava/lang/String;

    iget-object p2, v1, Landroid/support/c/a/i$f;->k:Landroid/support/v4/g/a;

    invoke-virtual {p2, p1, v1}, Landroid/support/v4/g/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private a()Z
    ...
    invoke-static {p0}, Landroid/support/v4/graphics/drawable/a;->h(Landroid/graphics/drawable/Drawable;)I
...
.method private b(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v3, v1, Landroid/support/c/a/i$f;->c:Landroid/support/c/a/i$c;
    ...
    check-cast v7, Landroid/support/c/a/i$c;
    ...
    invoke-virtual {v3, p1, p3, p4, p2}, Landroid/support/c/a/i$b;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v6, v7, Landroid/support/c/a/i$c;->b:Ljava/util/ArrayList;
    ...
    iget-object v6, v1, Landroid/support/c/a/i$f;->k:Landroid/support/v4/g/a;

    invoke-virtual {v3}, Landroid/support/c/a/i$b;->getPathName()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v6, v7, v3}, Landroid/support/v4/g/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_1
    const/4 v6, 0x0

    iget v7, v0, Landroid/support/c/a/i$g;->a:I
    ...
    new-instance v3, Landroid/support/c/a/i$a;

    invoke-direct {v3}, Landroid/support/c/a/i$a;-><init>()V

    invoke-virtual {v3, p1, p3, p4, p2}, Landroid/support/c/a/i$a;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    iget-object v7, v7, Landroid/support/c/a/i$c;->b:Ljava/util/ArrayList;

    invoke-virtual {v7, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v3}, Landroid/support/c/a/i$a;->getPathName()Ljava/lang/String;

    move-result-object v7

    if-eqz v7, :cond_3

    iget-object v7, v1, Landroid/support/c/a/i$f;->k:Landroid/support/v4/g/a;

    invoke-virtual {v3}, Landroid/support/c/a/i$a;->getPathName()Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v7, v8, v3}, Landroid/support/v4/g/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_3
    iget v7, v0, Landroid/support/c/a/i$g;->a:I

    iget v3, v3, Landroid/support/c/a/i$a;->o:I

    :goto_1
    or-int/2addr v3, v7

    iput v3, v0, Landroid/support/c/a/i$g;->a:I
    ...
    invoke-direct {v3}, Landroid/support/c/a/i$c;-><init>()V

    invoke-virtual {v3, p1, p3, p4, p2}, Landroid/support/c/a/i$c;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-virtual {v3}, Landroid/support/c/a/i$c;->getGroupName()Ljava/lang/String;
    ...
    iget v3, v3, Landroid/support/c/a/i$c;->e:I
...
.method a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroid/support/c/a/i$f;->k:Landroid/support/v4/g/a;
...
.method public canApplyTheme()Z
    ...
    invoke-static {v0}, Landroid/support/v4/graphics/drawable/a;->d(Landroid/graphics/drawable/Drawable;)Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Landroid/support/c/a/i;->i:[F
    ...
    invoke-virtual {v2, v1, v3}, Landroid/support/c/a/i$g;->b(II)V
    ...
    invoke-virtual {v2, v1, v3}, Landroid/support/c/a/i$g;->a(II)V
    ...
    invoke-virtual {v2}, Landroid/support/c/a/i$g;->b()Z
    ...
    invoke-virtual {v1}, Landroid/support/c/a/i$g;->c()V
    ...
    invoke-virtual {v1, p1, v0, v2}, Landroid/support/c/a/i$g;->a(Landroid/graphics/Canvas;Landroid/graphics/ColorFilter;Landroid/graphics/Rect;)V
...
.method public getAlpha()I
    ...
    invoke-static {v0}, Landroid/support/v4/graphics/drawable/a;->c(Landroid/graphics/drawable/Drawable;)I
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    new-instance v1, Landroid/support/c/a/i$f;

    invoke-direct {v1}, Landroid/support/c/a/i$f;-><init>()V

    iput-object v1, v0, Landroid/support/c/a/i$g;->b:Landroid/support/c/a/i$f;
    ...
    iput-boolean v1, v0, Landroid/support/c/a/i$g;->k:Z
    ...
    iget-object p1, p0, Landroid/support/c/a/i;->d:Landroid/graphics/PorterDuffColorFilter;

    iget-object p2, v0, Landroid/support/c/a/i$g;->c:Landroid/content/res/ColorStateList;

    iget-object p3, v0, Landroid/support/c/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, p1, p2, p3}, Landroid/support/c/a/i;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public isAutoMirrored()Z
    ...
    invoke-static {v0}, Landroid/support/v4/graphics/drawable/a;->b(Landroid/graphics/drawable/Drawable;)Z
...
.method public isStateful()Z
    ...
    invoke-virtual {v0}, Landroid/support/c/a/i$g;->d()Z
...
.method protected onStateChange([I)Z
    ...
    iget-object v4, v1, Landroid/support/c/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0, v0, v2, v4}, Landroid/support/c/a/i;->a(Landroid/graphics/PorterDuffColorFilter;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    :cond_1
    invoke-virtual {v1}, Landroid/support/c/a/i$g;->d()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1, p1}, Landroid/support/c/a/i$g;->a([I)Z
...
.method public setTint(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/c/a/i;->setTintList(Landroid/content/res/ColorStateList;)V
