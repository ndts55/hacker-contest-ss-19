...
.method public a(Landroid/support/v4/h/v;)Landroid/support/v7/view/h;
    .locals 1
...
.method public a(Landroid/support/v4/h/v;Landroid/support/v4/h/v;)Landroid/support/v7/view/h;
    .locals 2
    ...
    invoke-virtual {p1}, Landroid/support/v4/h/v;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/h/v;->b(J)Landroid/support/v4/h/v;
...
.method public a(Landroid/support/v4/h/w;)Landroid/support/v7/view/h;
    .locals 1
...
.method public a()V
    ...
    invoke-virtual {v1, v2, v3}, Landroid/support/v4/h/v;->a(J)Landroid/support/v4/h/v;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/h/v;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/h/v;

    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/h;->b:Landroid/support/v4/h/w;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/view/h;->f:Landroid/support/v4/h/x;

    invoke-virtual {v1, v2}, Landroid/support/v4/h/v;->a(Landroid/support/v4/h/w;)Landroid/support/v4/h/v;

    :cond_3
    invoke-virtual {v1}, Landroid/support/v4/h/v;->c()V
...
.method public c()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/h/v;->b()V
