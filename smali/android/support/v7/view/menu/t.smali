...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/h;Landroid/view/View;IIZ)V
    ...
    new-instance p3, Landroid/support/v7/widget/aw;
    ...
    invoke-direct {p3, p4, v0, p5, p6}, Landroid/support/v7/widget/aw;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/aw;
...
.method private h()Z
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/aw;

    invoke-virtual {v3, v0}, Landroid/support/v7/widget/aw;->b(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/aw;

    iget v3, p0, Landroid/support/v7/view/menu/t;->t:I

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/aw;->e(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/aw;->g(I)V

    iget-object v0, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/aw;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/aw;->h(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/aw;->a(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/aw;->e()Landroid/widget/ListView;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/aw;->a(Landroid/widget/ListAdapter;)V
...
.method public a(Landroid/support/v7/view/menu/u;)Z
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/aw;->j()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/aw;

    invoke-virtual {v3}, Landroid/support/v7/widget/aw;->k()I
    ...
    invoke-static {v5}, Landroid/support/v4/h/r;->f(Landroid/view/View;)I
