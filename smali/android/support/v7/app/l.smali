...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/l;->k:Z
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/app/l;->a(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroid/support/v7/app/l;->f:Landroid/view/View;
...
.method private a(Landroid/view/View;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/app/l;->b(Landroid/view/View;)Landroid/support/v7/widget/ak;
    ...
    iput-object p1, p0, Landroid/support/v7/app/l;->c:Landroid/support/v7/widget/ActionBarContainer;

    iget-object p1, p0, Landroid/support/v7/app/l;->d:Landroid/support/v7/widget/ak;

    if-eqz p1, :cond_7

    iget-object p1, p0, Landroid/support/v7/app/l;->e:Landroid/support/v7/widget/ActionBarContextView;

    if-eqz p1, :cond_7

    iget-object p1, p0, Landroid/support/v7/app/l;->c:Landroid/support/v7/widget/ActionBarContainer;

    if-eqz p1, :cond_7

    iget-object p1, p0, Landroid/support/v7/app/l;->d:Landroid/support/v7/widget/ak;

    invoke-interface {p1}, Landroid/support/v7/widget/ak;->b()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/app/l;->a:Landroid/content/Context;

    iget-object p1, p0, Landroid/support/v7/app/l;->d:Landroid/support/v7/widget/ak;

    invoke-interface {p1}, Landroid/support/v7/widget/ak;->o()I
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/app/l;->k(Z)V

    iget-object p1, p0, Landroid/support/v7/app/l;->a:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/app/l;->b(Z)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/app/l;->a(F)V
...
.method private k(Z)V
    ...
    iget-boolean p1, p0, Landroid/support/v7/app/l;->D:Z
    ...
    invoke-interface {p1, v0}, Landroid/support/v7/widget/ak;->a(Landroid/support/v7/widget/bg;)V

    iget-object p1, p0, Landroid/support/v7/app/l;->c:Landroid/support/v7/widget/ActionBarContainer;

    iget-object v0, p0, Landroid/support/v7/app/l;->g:Landroid/support/v7/widget/bg;

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/ActionBarContainer;->setTabContainer(Landroid/support/v7/widget/bg;)V
    ...
    :goto_0
    invoke-virtual {p0}, Landroid/support/v7/app/l;->i()I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/bg;->setVisibility(I)V
    ...
    invoke-static {v0}, Landroid/support/v4/h/r;->o(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/bg;->setVisibility(I)V
    ...
    :goto_3
    invoke-interface {v0, v3}, Landroid/support/v7/widget/ak;->a(Z)V
...
.method private l(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/app/l;->h(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/app/l;->i(Z)V
...
.method private n()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/l;->F:Z

    iget-object v1, p0, Landroid/support/v7/app/l;->b:Landroid/support/v7/widget/ActionBarOverlayLayout;
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/app/l;->l(Z)V
...
.method public a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/app/l;->j(Z)V
...
.method public a(F)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/h/r;->a(Landroid/view/View;F)V
...
.method public a(II)V
    ...
    invoke-interface {v1, p1}, Landroid/support/v7/widget/ak;->c(I)V
...
.method public a(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/l$a;->b()Landroid/view/Menu;
...
.method public b(Z)V
    ...
    :cond_1
    :goto_0
    iput-boolean p1, p0, Landroid/support/v7/app/l;->o:Z
...
.method public c(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/app/l;->f(Z)V
...
.method public d(Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/app/l;->n:Landroid/support/v7/view/h;
...
.method h()V
    ...
    iget-object v0, p0, Landroid/support/v7/app/l;->j:Landroid/support/v7/view/b$a;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/app/l;->j:Landroid/support/v7/view/b$a;

    iget-object v1, p0, Landroid/support/v7/app/l;->i:Landroid/support/v7/view/b;

    invoke-interface {v0, v1}, Landroid/support/v7/view/b$a;->a(Landroid/support/v7/view/b;)V

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v7/app/l;->i:Landroid/support/v7/view/b;

    iput-object v0, p0, Landroid/support/v7/app/l;->j:Landroid/support/v7/view/b$a;
...
.method public h(Z)V
    ...
    invoke-static {v2}, Landroid/support/v4/h/r;->k(Landroid/view/View;)Landroid/support/v4/h/v;

    move-result-object v2

    invoke-virtual {v2, v1}, Landroid/support/v4/h/v;->b(F)Landroid/support/v4/h/v;
    ...
    invoke-virtual {p1, v2}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/v;)Landroid/support/v7/view/h;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/h/v;->b(F)Landroid/support/v4/h/v;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/v;)Landroid/support/v7/view/h;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/w;)Landroid/support/v7/view/h;

    iput-object p1, p0, Landroid/support/v7/app/l;->n:Landroid/support/v7/view/h;
    ...
    iget-boolean p1, p0, Landroid/support/v7/app/l;->k:Z

    if-eqz p1, :cond_5

    iget-object p1, p0, Landroid/support/v7/app/l;->f:Landroid/view/View;
    ...
    :cond_5
    iget-object p1, p0, Landroid/support/v7/app/l;->q:Landroid/support/v4/h/w;

    const/4 v0, 0x0

    invoke-interface {p1, v0}, Landroid/support/v4/h/w;->b(Landroid/view/View;)V

    :goto_0
    iget-object p1, p0, Landroid/support/v7/app/l;->b:Landroid/support/v7/widget/ActionBarOverlayLayout;

    if-eqz p1, :cond_6

    iget-object p1, p0, Landroid/support/v7/app/l;->b:Landroid/support/v7/widget/ActionBarOverlayLayout;

    invoke-static {p1}, Landroid/support/v4/h/r;->o(Landroid/view/View;)V
...
.method public i(Z)V
    ...
    invoke-static {p1}, Landroid/support/v4/h/r;->k(Landroid/view/View;)Landroid/support/v4/h/v;

    move-result-object p1

    invoke-virtual {p1, v2}, Landroid/support/v4/h/v;->b(F)Landroid/support/v4/h/v;

    move-result-object p1

    iget-object v1, p0, Landroid/support/v7/app/l;->r:Landroid/support/v4/h/y;

    invoke-virtual {p1, v1}, Landroid/support/v4/h/v;->a(Landroid/support/v4/h/y;)Landroid/support/v4/h/v;

    invoke-virtual {v0, p1}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/v;)Landroid/support/v7/view/h;
    ...
    :cond_3
    sget-object p1, Landroid/support/v7/app/l;->t:Landroid/view/animation/Interpolator;
    ...
    iget-object p1, p0, Landroid/support/v7/app/l;->p:Landroid/support/v4/h/w;

    invoke-virtual {v0, p1}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/w;)Landroid/support/v7/view/h;
...
.method public j(Z)V
    ...
    invoke-direct {p0}, Landroid/support/v7/app/l;->n()V

    goto :goto_0

    :cond_0
    invoke-direct {p0}, Landroid/support/v7/app/l;->o()V

    :goto_0
    invoke-direct {p0}, Landroid/support/v7/app/l;->p()Z
    ...
    invoke-interface {p1, v2, v6, v7}, Landroid/support/v7/widget/ak;->a(IJ)Landroid/support/v4/h/v;

    move-result-object p1

    iget-object v0, p0, Landroid/support/v7/app/l;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v0, v3, v4, v5}, Landroid/support/v7/widget/ActionBarContextView;->a(IJ)Landroid/support/v4/h/v;
    ...
    invoke-interface {p1, v3, v4, v5}, Landroid/support/v7/widget/ak;->a(IJ)Landroid/support/v4/h/v;

    move-result-object v0

    iget-object p1, p0, Landroid/support/v7/app/l;->e:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {p1, v1, v6, v7}, Landroid/support/v7/widget/ActionBarContextView;->a(IJ)Landroid/support/v4/h/v;
    ...
    invoke-virtual {v1, p1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/h/v;Landroid/support/v4/h/v;)Landroid/support/v7/view/h;
    ...
    invoke-interface {p1, v2}, Landroid/support/v7/widget/ak;->d(I)V
    ...
    invoke-interface {p1, v3}, Landroid/support/v7/widget/ak;->d(I)V
