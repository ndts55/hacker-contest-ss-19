...
.field l:Landroid/support/v4/h/v;
...
.field private y:Landroid/support/v7/widget/aj;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/d;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/f;->l:Landroid/support/v4/h/v;
    ...
    invoke-static {p1, v0, p2}, Landroid/support/v7/widget/bo;->a(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroid/support/v7/widget/bo;

    move-result-object p1

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Landroid/support/v7/widget/bo;->b(I)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/support/v7/view/menu/h;Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/app/f;->y:Landroid/support/v7/widget/aj;
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/aj;->e()Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/aj;->g()Z
    ...
    iget-object v2, p0, Landroid/support/v7/app/f;->y:Landroid/support/v7/widget/aj;

    invoke-interface {v2}, Landroid/support/v7/widget/aj;->f()Z
    ...
    :cond_1
    iget-object p2, p0, Landroid/support/v7/app/f;->y:Landroid/support/v7/widget/aj;

    invoke-interface {p2}, Landroid/support/v7/widget/aj;->i()Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/aj;->h()Z
...
.method private a(Landroid/support/v7/app/f$f;ILandroid/view/KeyEvent;I)Z
    ...
    iget-object p3, p0, Landroid/support/v7/app/f;->y:Landroid/support/v7/widget/aj;
...
.method private b(Landroid/support/v7/app/f$f;)Z
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/app/f;->y:Landroid/support/v7/widget/aj;
...
.method private b(Landroid/support/v7/app/f$f;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/f;->y:Landroid/support/v7/widget/aj;

    if-eqz v4, :cond_6

    iget-object v4, p0, Landroid/support/v7/app/f;->y:Landroid/support/v7/widget/aj;

    invoke-interface {v4}, Landroid/support/v7/widget/aj;->j()V
    ...
    invoke-interface {v4, v6, v7}, Landroid/support/v7/widget/aj;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-interface {p1, v5, p2}, Landroid/support/v7/widget/aj;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-interface {p2, v5, v0}, Landroid/support/v7/widget/aj;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
...
.method private e(ILandroid/view/KeyEvent;)Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/aj;->f()Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/aj;->i()Z
...
.method private j(I)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/h/r;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method private v()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroid/support/v7/app/f;->y:Landroid/support/v7/widget/aj;
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/aj;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v1, v4}, Landroid/support/v7/widget/aj;->a(I)V
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/aj;->a(I)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/h/r;->a(Landroid/view/View;Landroid/support/v4/h/p;)V
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/ap;->setOnFitSystemWindowsListener(Landroid/support/v7/widget/ap$a;)V
    ...
    :cond_d
    invoke-static {v0}, Landroid/support/v7/widget/bw;->b(Landroid/view/View;)V
...
.method a(Landroid/support/v7/app/f$f;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/f;->y:Landroid/support/v7/widget/aj;
...
.method b(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/h/v;->a(F)Landroid/support/v4/h/v;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/app/f;->l:Landroid/support/v4/h/v;

    iget-object p1, p0, Landroid/support/v7/app/f;->l:Landroid/support/v4/h/v;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/h/v;->a(Landroid/support/v4/h/w;)Landroid/support/v4/h/v;
...
.method b(Landroid/support/v7/view/menu/h;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/aj;->k()V
...
.method h(I)I
    ...
    invoke-static {v5, v2, v4}, Landroid/support/v7/widget/bw;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method q()V
    ...
    iget-object v0, p0, Landroid/support/v7/app/f;->l:Landroid/support/v4/h/v;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/app/f;->l:Landroid/support/v4/h/v;

    invoke-virtual {v0}, Landroid/support/v4/h/v;->b()V
