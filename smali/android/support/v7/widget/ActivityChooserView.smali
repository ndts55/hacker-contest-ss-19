...
.method a(I)V
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/au;->d()Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/au;->g(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/h/c;->a(Z)V

    :cond_4
    invoke-virtual {p1}, Landroid/support/v7/widget/au;->e()Landroid/widget/ListView;
...
.method getListPopupWindow()Landroid/support/v7/widget/au;
    .locals 2
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/au;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/au;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method public setProvider(Landroid/support/v4/h/c;)V
    .locals 0
