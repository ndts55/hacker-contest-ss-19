...
.method constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/an;->b:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/an;->setCacheColorHint(I)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/an;->h:Ljava/lang/reflect/Field;

    iget-object p1, p0, Landroid/support/v7/widget/an;->h:Ljava/lang/reflect/Field;
...
.method private a(ILandroid/view/View;)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/an;->b(ILandroid/view/View;)V

    if-eqz v3, :cond_3

    iget-object p1, p0, Landroid/support/v7/widget/an;->b:Landroid/graphics/Rect;
...
.method private a(ILandroid/view/View;FF)V
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/an;->a(ILandroid/view/View;)V
...
.method private a(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/widget/an;->getItemIdAtPosition(I)J

    move-result-wide v0

    invoke-virtual {p0, p1, p2, v0, v1}, Landroid/support/v7/widget/an;->performItemClick(Landroid/view/View;IJ)Z
...
.method private a(Landroid/view/View;IFF)V
    ...
    invoke-virtual {p0, p3, p4}, Landroid/support/v7/widget/an;->drawableHotspotChanged(FF)V
    ...
    :cond_2
    iput p2, p0, Landroid/support/v7/widget/an;->g:I
    ...
    :cond_4
    invoke-direct {p0, p2, p1, p3, p4}, Landroid/support/v7/widget/an;->a(ILandroid/view/View;FF)V

    invoke-direct {p0, v4}, Landroid/support/v7/widget/an;->setSelectorEnabled(Z)V
...
.method private b(ILandroid/view/View;)V
    ...
    iget v2, p0, Landroid/support/v7/widget/an;->d:I
    ...
    iget-object p2, p0, Landroid/support/v7/widget/an;->h:Ljava/lang/reflect/Field;
...
.method private c()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/an;->l:Z
...
.method private setSelectorEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/an$a;->a(Z)V
...
.method public a(Landroid/view/MotionEvent;I)Z
    ...
    invoke-virtual {p0, v4, p2}, Landroid/support/v7/widget/an;->pointToPosition(II)I
    ...
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/an;->getChildAt(I)Landroid/view/View;
    ...
    invoke-direct {p0, v3, v5, v4, p2}, Landroid/support/v7/widget/an;->a(Landroid/view/View;IFF)V

    if-ne v0, v2, :cond_0

    invoke-direct {p0, v3, v5}, Landroid/support/v7/widget/an;->a(Landroid/view/View;I)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/an;->n:Landroid/support/v4/widget/i;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/an;->n:Landroid/support/v4/widget/i;

    :cond_5
    iget-object p2, p0, Landroid/support/v7/widget/an;->n:Landroid/support/v4/widget/i;

    invoke-virtual {p2, v2}, Landroid/support/v4/widget/i;->a(Z)Landroid/support/v4/widget/a;

    iget-object p2, p0, Landroid/support/v7/widget/an;->n:Landroid/support/v4/widget/i;

    invoke-virtual {p2, p0, p1}, Landroid/support/v4/widget/i;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z

    goto :goto_4

    :cond_6
    iget-object p1, p0, Landroid/support/v7/widget/an;->n:Landroid/support/v4/widget/i;

    if-eqz p1, :cond_7

    iget-object p1, p0, Landroid/support/v7/widget/an;->n:Landroid/support/v4/widget/i;

    invoke-virtual {p1, v1}, Landroid/support/v4/widget/i;->a(Z)Landroid/support/v4/widget/a;
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/an;->a(Landroid/graphics/Canvas;)V
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/an;->a:Landroid/support/v7/widget/an$b;

    if-nez v1, :cond_1

    new-instance v1, Landroid/support/v7/widget/an$b;

    invoke-direct {v1, p0}, Landroid/support/v7/widget/an$b;-><init>(Landroid/support/v7/widget/an;)V

    iput-object v1, p0, Landroid/support/v7/widget/an;->a:Landroid/support/v7/widget/an$b;

    iget-object v1, p0, Landroid/support/v7/widget/an;->a:Landroid/support/v7/widget/an$b;

    invoke-virtual {v1}, Landroid/support/v7/widget/an$b;->b()V
    ...
    invoke-virtual {p0, v0, p1}, Landroid/support/v7/widget/an;->pointToPosition(II)I
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/an;->setSelectionFromTop(II)V
