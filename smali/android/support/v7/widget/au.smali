...
.field c:Landroid/support/v7/widget/an;
...
.method static constructor <clinit>()V
    ...
    sput-object v2, Landroid/support/v7/widget/au;->a:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sput-object v2, Landroid/support/v7/widget/au;->b:Ljava/lang/reflect/Method;
    :try_end_1
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v1, v0}, Landroid/support/v7/widget/au;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean v1, p0, Landroid/support/v7/widget/au;->u:Z

    iput-boolean v1, p0, Landroid/support/v7/widget/au;->v:Z

    const v2, 0x7fffffff

    iput v2, p0, Landroid/support/v7/widget/au;->d:I

    iput v1, p0, Landroid/support/v7/widget/au;->x:I

    new-instance v2, Landroid/support/v7/widget/au$e;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/au$e;-><init>(Landroid/support/v7/widget/au;)V

    iput-object v2, p0, Landroid/support/v7/widget/au;->e:Landroid/support/v7/widget/au$e;

    new-instance v2, Landroid/support/v7/widget/au$d;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/au$d;-><init>(Landroid/support/v7/widget/au;)V

    iput-object v2, p0, Landroid/support/v7/widget/au;->D:Landroid/support/v7/widget/au$d;

    new-instance v2, Landroid/support/v7/widget/au$c;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/au$c;-><init>(Landroid/support/v7/widget/au;)V

    iput-object v2, p0, Landroid/support/v7/widget/au;->E:Landroid/support/v7/widget/au$c;

    new-instance v2, Landroid/support/v7/widget/au$a;

    invoke-direct {v2, p0}, Landroid/support/v7/widget/au$a;-><init>(Landroid/support/v7/widget/au;)V

    iput-object v2, p0, Landroid/support/v7/widget/au;->F:Landroid/support/v7/widget/au$a;

    new-instance v2, Landroid/graphics/Rect;

    invoke-direct {v2}, Landroid/graphics/Rect;-><init>()V

    iput-object v2, p0, Landroid/support/v7/widget/au;->H:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/au;->f:Landroid/os/Handler;
    ...
    iput v3, p0, Landroid/support/v7/widget/au;->m:I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/au;->g:Landroid/widget/PopupWindow;

    iget-object p1, p0, Landroid/support/v7/widget/au;->g:Landroid/widget/PopupWindow;
...
.method private a(Landroid/view/View;IZ)I
    ...
    :cond_0
    iget-object p3, p0, Landroid/support/v7/widget/au;->g:Landroid/widget/PopupWindow;
...
.method private f()I
    ...
    new-instance v5, Landroid/support/v7/widget/au$1;

    invoke-direct {v5, p0}, Landroid/support/v7/widget/au$1;-><init>(Landroid/support/v7/widget/au;)V

    iput-object v5, p0, Landroid/support/v7/widget/au;->G:Ljava/lang/Runnable;

    iget-boolean v5, p0, Landroid/support/v7/widget/au;->J:Z

    xor-int/2addr v5, v3

    invoke-virtual {p0, v0, v5}, Landroid/support/v7/widget/au;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/an;

    move-result-object v5

    iput-object v5, p0, Landroid/support/v7/widget/au;->c:Landroid/support/v7/widget/an;

    iget-object v5, p0, Landroid/support/v7/widget/au;->A:Landroid/graphics/drawable/Drawable;

    if-eqz v5, :cond_0

    iget-object v5, p0, Landroid/support/v7/widget/au;->c:Landroid/support/v7/widget/an;
    ...
    invoke-virtual {v5, v3}, Landroid/support/v7/widget/an;->setFocusable(Z)V

    iget-object v5, p0, Landroid/support/v7/widget/au;->c:Landroid/support/v7/widget/an;

    invoke-virtual {v5, v3}, Landroid/support/v7/widget/an;->setFocusableInTouchMode(Z)V
    ...
    iget-object v5, p0, Landroid/support/v7/widget/au;->C:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/au;->w:Landroid/view/View;
    ...
    :goto_3
    iget-object v5, p0, Landroid/support/v7/widget/au;->g:Landroid/widget/PopupWindow;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/au;->H:Landroid/graphics/Rect;
    ...
    iget-boolean v6, p0, Landroid/support/v7/widget/au;->p:Z
    ...
    iput v6, p0, Landroid/support/v7/widget/au;->n:I
    ...
    iget v6, p0, Landroid/support/v7/widget/au;->n:I

    invoke-direct {p0, v4, v6, v3}, Landroid/support/v7/widget/au;->a(Landroid/view/View;IZ)I

    move-result v3

    iget-boolean v4, p0, Landroid/support/v7/widget/au;->u:Z
    ...
    :cond_9
    iget v2, p0, Landroid/support/v7/widget/au;->l:I

    const/high16 v4, 0x40000000    # 2.0f

    packed-switch v2, :pswitch_data_1

    iget v1, p0, Landroid/support/v7/widget/au;->l:I
    ...
    :pswitch_2
    iget-object v1, p0, Landroid/support/v7/widget/au;->i:Landroid/content/Context;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/au;->H:Landroid/graphics/Rect;
    ...
    :pswitch_3
    iget-object v2, p0, Landroid/support/v7/widget/au;->i:Landroid/content/Context;
    ...
    :goto_8
    iget-object v6, p0, Landroid/support/v7/widget/au;->c:Landroid/support/v7/widget/an;
    ...
    invoke-virtual/range {v6 .. v11}, Landroid/support/v7/widget/an;->a(IIIII)I

    move-result v1

    if-lez v1, :cond_a

    iget-object v2, p0, Landroid/support/v7/widget/au;->c:Landroid/support/v7/widget/an;

    invoke-virtual {v2}, Landroid/support/v7/widget/an;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/widget/au;->c:Landroid/support/v7/widget/an;

    invoke-virtual {v3}, Landroid/support/v7/widget/an;->getPaddingBottom()I
...
.method public a()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/au;->g:Landroid/widget/PopupWindow;

    iget v3, p0, Landroid/support/v7/widget/au;->o:I
    ...
    invoke-static {v2}, Landroid/support/v4/h/r;->z(Landroid/view/View;)Z
    ...
    :goto_0
    iget v7, p0, Landroid/support/v7/widget/au;->k:I
    ...
    :cond_7
    iget v1, p0, Landroid/support/v7/widget/au;->k:I
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/au;->v:Z
    ...
    iget-object v7, p0, Landroid/support/v7/widget/au;->g:Landroid/widget/PopupWindow;

    invoke-virtual {p0}, Landroid/support/v7/widget/au;->i()Landroid/view/View;

    move-result-object v8

    iget v9, p0, Landroid/support/v7/widget/au;->m:I

    iget v10, p0, Landroid/support/v7/widget/au;->n:I
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/au;->v:Z

    if-nez v1, :cond_11

    iget-boolean v1, p0, Landroid/support/v7/widget/au;->u:Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/au;->I:Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/an;->setSelection(I)V
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/au;->c:Landroid/support/v7/widget/an;
...
.method public c()V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/au;->c:Landroid/support/v7/widget/an;
...
.method public i(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/an;->setSelection(I)V

    invoke-virtual {v0}, Landroid/support/v7/widget/an;->getChoiceMode()I
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v7/widget/an;->setItemChecked(IZ)V
