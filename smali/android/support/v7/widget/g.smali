...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/g;->f:Landroid/support/v7/widget/bm;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->f:Landroid/support/v7/widget/bm;
    ...
    invoke-static {v1}, Landroid/support/v4/h/r;->s(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Landroid/support/v4/h/r;->t(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v1

    if-eqz v1, :cond_2

    iput-boolean v2, v0, Landroid/support/v7/widget/bm;->c:Z

    iput-object v1, v0, Landroid/support/v7/widget/bm;->b:Landroid/graphics/PorterDuff$Mode;

    :cond_2
    iget-boolean v1, v0, Landroid/support/v7/widget/bm;->d:Z

    if-nez v1, :cond_4

    iget-boolean v1, v0, Landroid/support/v7/widget/bm;->c:Z
    ...
    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bm;[I)V
...
.method private d()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bm;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bm;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bm;

    iget-object v0, v0, Landroid/support/v7/widget/bm;->a:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bm;

    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bm;

    iput-object p1, v0, Landroid/support/v7/widget/bm;->a:Landroid/content/res/ColorStateList;

    iget-object p1, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bm;

    const/4 v0, 0x1

    iput-boolean v0, p1, Landroid/support/v7/widget/bm;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, v0, Landroid/support/v7/widget/bm;->b:Landroid/graphics/PorterDuff$Mode;

    iget-object p1, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bm;

    const/4 v0, 0x1

    iput-boolean v0, p1, Landroid/support/v7/widget/bm;->c:Z
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/bo;->g(I)Z
    ...
    invoke-virtual {p1, p2, v0}, Landroid/support/v7/widget/bo;->g(II)I
    ...
    invoke-virtual {p1, v1}, Landroid/support/v7/widget/bo;->e(I)Landroid/content/res/ColorStateList;

    move-result-object v1

    invoke-static {p2, v1}, Landroid/support/v4/h/r;->a(Landroid/view/View;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/widget/bo;->a(II)I
    ...
    invoke-static {p2, v0}, Landroid/support/v4/h/r;->a(Landroid/view/View;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/bm;->b:Landroid/graphics/PorterDuff$Mode;
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bm;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bm;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bm;
...
.method c()V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/g;->e:Landroid/support/v7/widget/bm;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bm;[I)V

    goto :goto_1

    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/g;->d:Landroid/support/v7/widget/bm;
