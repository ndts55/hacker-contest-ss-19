...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/g;
    ...
    :goto_0
    iput-object v3, p0, Landroid/support/v7/widget/y;->f:Landroid/content/Context;
    ...
    invoke-virtual {v0, p5, v1}, Landroid/support/v7/widget/bo;->g(II)I
    ...
    :goto_1
    iput-object p5, p0, Landroid/support/v7/widget/y;->f:Landroid/content/Context;

    :goto_2
    iget-object p5, p0, Landroid/support/v7/widget/y;->f:Landroid/content/Context;
    ...
    :try_start_0
    sget-object p5, Landroid/support/v7/widget/y;->d:[I
    ...
    invoke-static {p5, p2, v4, p3, v1}, Landroid/support/v7/widget/bo;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bo;
    ...
    invoke-virtual {p5, v1, v4}, Landroid/support/v7/widget/bo;->f(II)I
    ...
    invoke-virtual {p5, v1}, Landroid/support/v7/widget/bo;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bo;->d(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p4, v1}, Landroid/support/v7/widget/y$b;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {p5}, Landroid/support/v7/widget/bo;->a()V

    iput-object p4, p0, Landroid/support/v7/widget/y;->a:Landroid/support/v7/widget/y$b;
    ...
    iput-object p5, p0, Landroid/support/v7/widget/y;->g:Landroid/support/v7/widget/aq;

    :cond_6
    sget p4, Landroid/support/v7/a/a$j;->Spinner_android_entries:I

    invoke-virtual {v0, p4}, Landroid/support/v7/widget/bo;->f(I)[Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/y;->h:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/y;->h:Landroid/widget/SpinnerAdapter;

    :cond_8
    iget-object p1, p0, Landroid/support/v7/widget/y;->e:Landroid/support/v7/widget/g;
...
.method a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object p1, p0, Landroid/support/v7/widget/y;->c:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/y;->c:Landroid/graphics/Rect;
...
.method protected onMeasure(II)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/y;->a:Landroid/support/v7/widget/y$b;
