...
.method public static a(Landroid/content/Context;I[I)Landroid/support/v7/widget/bo;
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v7/widget/bo;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
...
.method public a(IILandroid/support/v4/a/a/f$a;)Landroid/graphics/Typeface;
    .locals 2
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/bo;->c:Landroid/util/TypedValue;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bo;->c:Landroid/util/TypedValue;

    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/bo;->a:Landroid/content/Context;

    iget-object v1, p0, Landroid/support/v7/widget/bo;->c:Landroid/util/TypedValue;

    invoke-static {v0, p1, v1, p2, p3}, Landroid/support/v4/a/a/f;->a(Landroid/content/Context;ILandroid/util/TypedValue;ILandroid/support/v4/a/a/f$a;)Landroid/graphics/Typeface;
...
.method public a(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/bo;->a:Landroid/content/Context;
