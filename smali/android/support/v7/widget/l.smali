...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/l$c;-><init>(I)V
...
.method public static declared-synchronized a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    const-class v0, Landroid/support/v7/widget/l;

    monitor-enter v0

    :try_start_0
    sget-object v1, Landroid/support/v7/widget/l;->c:Landroid/support/v7/widget/l$c;

    invoke-virtual {v1, p0, p1}, Landroid/support/v7/widget/l$c;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v2, p0, p1, v1}, Landroid/support/v7/widget/l$c;->a(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/bj;->a(Landroid/content/Context;I)I
    ...
    invoke-static {p1, p3}, Landroid/support/v7/widget/bj;->a(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/bj;->c(Landroid/content/Context;I)I
...
.method public static declared-synchronized a()Landroid/support/v7/widget/l;
    ...
    :try_start_0
    sget-object v1, Landroid/support/v7/widget/l;->b:Landroid/support/v7/widget/l;

    if-nez v1, :cond_0

    new-instance v1, Landroid/support/v7/widget/l;

    invoke-direct {v1}, Landroid/support/v7/widget/l;-><init>()V

    sput-object v1, Landroid/support/v7/widget/l;->b:Landroid/support/v7/widget/l;

    sget-object v1, Landroid/support/v7/widget/l;->b:Landroid/support/v7/widget/l;

    invoke-static {v1}, Landroid/support/v7/widget/l;->a(Landroid/support/v7/widget/l;)V
...
.method private a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    :cond_1
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/g/m;->c(ILjava/lang/Object;)V
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bm;[I)V
    .locals 2
    ...
    :cond_0
    iget-boolean v0, p1, Landroid/support/v7/widget/bm;->d:Z

    if-nez v0, :cond_2

    iget-boolean v0, p1, Landroid/support/v7/widget/bm;->c:Z
    ...
    iget-object v0, p1, Landroid/support/v7/widget/bm;->a:Landroid/content/res/ColorStateList;
    ...
    :goto_1
    iget-boolean v1, p1, Landroid/support/v7/widget/bm;->c:Z

    if-eqz v1, :cond_4

    iget-object p1, p1, Landroid/support/v7/widget/bm;->b:Landroid/graphics/PorterDuff$Mode;
...
.method private static a(Landroid/support/v7/widget/l;)V
    ...
    new-instance v1, Landroid/support/v7/widget/l$e;

    invoke-direct {v1}, Landroid/support/v7/widget/l$e;-><init>()V

    invoke-direct {p0, v0, v1}, Landroid/support/v7/widget/l;->a(Ljava/lang/String;Landroid/support/v7/widget/l$d;)V

    const-string v0, "animated-vector"

    new-instance v1, Landroid/support/v7/widget/l$b;

    invoke-direct {v1}, Landroid/support/v7/widget/l$b;-><init>()V
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    :cond_5
    invoke-static {p0, v2}, Landroid/support/v7/widget/bj;->a(Landroid/content/Context;I)I
...
.method private declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/l;->m:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p2, p3, p1}, Landroid/support/v4/g/f;->b(JLjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static a(Landroid/graphics/drawable/Drawable;)Z
    ...
    instance-of v0, p0, Landroid/support/c/a/i;
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p2}, Landroid/support/v4/g/m;->a(I)Ljava/lang/Object;
    ...
    invoke-virtual {v7, p2, v2}, Landroid/support/v4/g/m;->c(ILjava/lang/Object;)V
    ...
    check-cast v2, Landroid/support/v7/widget/l$d;
    ...
    invoke-interface {v2, p1, v1, v6, v7}, Landroid/support/v7/widget/l$d;->a(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/l;->l:Landroid/support/v4/g/m;

    const-string v0, "appcompat_skip_skip"

    invoke-virtual {p1, p2, v0}, Landroid/support/v4/g/m;->c(ILjava/lang/Object;)V
...
.method private e(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/bj;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v6, Landroid/support/v7/widget/bj;->a:[I
    ...
    sget-object v5, Landroid/support/v7/widget/bj;->e:[I

    aput-object v5, v1, v4

    sget v5, Landroid/support/v7/a/a$a;->colorControlActivated:I

    invoke-static {p1, v5}, Landroid/support/v7/widget/bj;->a(Landroid/content/Context;I)I

    move-result p1

    aput p1, v0, v4

    sget-object p1, Landroid/support/v7/widget/bj;->h:[I
    ...
    :cond_0
    sget-object v2, Landroid/support/v7/widget/bj;->a:[I

    aput-object v2, v1, v5

    sget v2, Landroid/support/v7/a/a$a;->colorSwitchThumbNormal:I

    invoke-static {p1, v2}, Landroid/support/v7/widget/bj;->c(Landroid/content/Context;I)I

    move-result v2

    aput v2, v0, v5

    sget-object v2, Landroid/support/v7/widget/bj;->e:[I

    aput-object v2, v1, v4

    sget v2, Landroid/support/v7/a/a$a;->colorControlActivated:I

    invoke-static {p1, v2}, Landroid/support/v7/widget/bj;->a(Landroid/content/Context;I)I

    move-result v2

    aput v2, v0, v4

    sget-object v2, Landroid/support/v7/widget/bj;->h:[I
...
.method private e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    check-cast p1, Landroid/support/v4/g/m;

    if-eqz p1, :cond_0

    invoke-virtual {p1, p2}, Landroid/support/v4/g/m;->a(I)Ljava/lang/Object;
...
.method private f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/bj;->c(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroid/support/v7/widget/bj;->a:[I
    ...
    sget-object p1, Landroid/support/v7/widget/bj;->d:[I

    const/4 v3, 0x1

    aput-object p1, v1, v3

    invoke-static {v2, p2}, Landroid/support/v4/graphics/a;->a(II)I

    move-result p1

    aput p1, v0, v3

    sget-object p1, Landroid/support/v7/widget/bj;->b:[I
...
.method private f(Landroid/content/Context;)V
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/l;->o:Z
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/l;->o:Z
...
.method declared-synchronized a(Landroid/content/Context;Landroid/support/v7/widget/bt;I)Landroid/graphics/drawable/Drawable;
    .locals 1
    ...
    invoke-virtual {p2, p3}, Landroid/support/v7/widget/bt;->a(I)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/bj;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
