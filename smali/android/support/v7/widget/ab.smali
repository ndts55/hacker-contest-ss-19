...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/ab;->b:Ljava/util/concurrent/ConcurrentHashMap;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput v1, p0, Landroid/support/v7/widget/ab;->e:F

    iput v1, p0, Landroid/support/v7/widget/ab;->f:F

    iput v1, p0, Landroid/support/v7/widget/ab;->g:F

    new-array v1, v0, [I

    iput-object v1, p0, Landroid/support/v7/widget/ab;->h:[I
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ab;->k:Landroid/widget/TextView;

    invoke-virtual {p1}, Landroid/widget/TextView;->getContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/ab;->l:Landroid/content/Context;
...
.method private a(Landroid/graphics/RectF;)I
    ...
    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/ab;->h:[I
...
.method private a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    invoke-direct {p0, v1, v2, v3}, Landroid/support/v7/widget/ab;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v2, v3, v4}, Landroid/support/v7/widget/ab;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/ab;->j:Landroid/text/TextPaint;
...
.method private a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    iget-object p2, p0, Landroid/support/v7/widget/ab;->k:Landroid/widget/TextView;

    invoke-virtual {p2}, Landroid/widget/TextView;->getLineSpacingExtra()F

    move-result p2

    iget-object p3, p0, Landroid/support/v7/widget/ab;->k:Landroid/widget/TextView;
...
.method private a(Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    :try_start_0
    sget-object v0, Landroid/support/v7/widget/ab;->b:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object v1, Landroid/support/v7/widget/ab;->b:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private a(F)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/ab;->a(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private a(FFF)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/ab;->i:Z
...
.method private a(Landroid/content/res/TypedArray;)V
    ...
    :cond_0
    invoke-direct {p0, v1}, Landroid/support/v7/widget/ab;->a([I)[I

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/widget/ab;->h:[I
...
.method private a(ILandroid/graphics/RectF;)Z
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ab;->j:Landroid/text/TextPaint;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ab;->k:Landroid/widget/TextView;
    ...
    invoke-direct {p0, p1, v2, v4}, Landroid/support/v7/widget/ab;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v0, p1, v2, v1}, Landroid/support/v7/widget/ab;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    invoke-direct {p0, v0, p1, v2}, Landroid/support/v7/widget/ab;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
...
.method private h()Z
    ...
    :goto_0
    iput-boolean v3, p0, Landroid/support/v7/widget/ab;->i:Z

    iget-boolean v3, p0, Landroid/support/v7/widget/ab;->i:Z

    if-eqz v3, :cond_1

    iput v2, p0, Landroid/support/v7/widget/ab;->c:I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ab;->h:[I
...
.method private i()Z
    ...
    iget v4, p0, Landroid/support/v7/widget/ab;->f:F
...
.method a(I)V
    ...
    :pswitch_0
    iget-object p1, p0, Landroid/support/v7/widget/ab;->l:Landroid/content/Context;
    ...
    invoke-direct {p0, v0, p1, v1}, Landroid/support/v7/widget/ab;->a(FFF)V
...
.method a(IF)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ab;->a(F)V
...
.method a(IIII)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/ab;->a(FFF)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, v4}, Landroid/support/v7/widget/ab;->a(Landroid/content/res/TypedArray;)V
    ...
    iget-boolean p1, p0, Landroid/support/v7/widget/ab;->i:Z
    ...
    :cond_7
    invoke-direct {p0, v1, v3, p2}, Landroid/support/v7/widget/ab;->a(FFF)V
...
.method a([II)V
    ...
    iput-object p2, p0, Landroid/support/v7/widget/ab;->h:[I
...
.method f()V
    ...
    invoke-direct {p0, v0, v1, v3}, Landroid/support/v7/widget/ab;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    sget-object v4, Landroid/support/v7/widget/ab;->a:Landroid/graphics/RectF;
    ...
    invoke-virtual {p0, v2, v0}, Landroid/support/v7/widget/ab;->a(IF)V
