...
.method static synthetic a(Landroid/support/v7/widget/c;)Landroid/support/v7/view/menu/h;
    ...
    iget-object p0, p0, Landroid/support/v7/widget/c;->c:Landroid/support/v7/view/menu/h;
...
.method static synthetic c(Landroid/support/v7/widget/c;)Landroid/support/v7/view/menu/p;
    ...
    iget-object p0, p0, Landroid/support/v7/widget/c;->f:Landroid/support/v7/view/menu/p;
...
.method public a(Landroid/content/res/Configuration;)V
    ...
    :cond_0
    iget-object p1, p0, Landroid/support/v7/widget/c;->c:Landroid/support/v7/view/menu/h;
...
.method public a(Landroid/support/v7/view/menu/j;Landroid/support/v7/view/menu/p$a;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/c;->f:Landroid/support/v7/view/menu/p;
...
.method public a(Landroid/support/v7/view/menu/u;)Z
    ...
    invoke-direct {v2, p0, v3, p1, v0}, Landroid/support/v7/widget/c$a;-><init>(Landroid/support/v7/widget/c;Landroid/content/Context;Landroid/support/v7/view/menu/u;Landroid/view/View;)V
...
.method public b(Z)V
    ...
    invoke-virtual {v3}, Landroid/support/v7/view/menu/j;->a()Landroid/support/v4/h/c;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3, p0}, Landroid/support/v4/h/c;->a(Landroid/support/v4/h/c$a;)V
...
.method public b()Z
    ...
    iget-object v1, v0, Landroid/support/v7/widget/c;->c:Landroid/support/v7/view/menu/h;
    ...
    iget-object v7, v0, Landroid/support/v7/widget/c;->f:Landroid/support/v7/view/menu/p;
    ...
    invoke-virtual {v0, v14, v15, v7}, Landroid/support/v7/widget/c;->a(Landroid/support/v7/view/menu/j;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {v0, v14, v2, v7}, Landroid/support/v7/widget/c;->a(Landroid/support/v7/view/menu/j;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
...
.method public c()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/c;->m:Landroid/graphics/drawable/Drawable;
...
.method public d()Z
    ...
    invoke-direct/range {v1 .. v6}, Landroid/support/v7/widget/c$e;-><init>(Landroid/support/v7/widget/c;Landroid/content/Context;Landroid/support/v7/view/menu/h;Landroid/view/View;Z)V
...
.method public g()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/c$a;->d()V
...
.method public h()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/c$e;->f()Z
